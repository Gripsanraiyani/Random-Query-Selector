...
function generate1(){
  // grab all the keys in the dictionary (authors) and store in an array
  const authors1 = Object.keys(quotes);
  // grab a random key (author) and store it in author
  const author1 = authors1[Math.floor(Math.random() * authors1.length)];
  // grab the value(quote) that belongs to that key
  const quote1 = quotes[author]

  document.querySelector("#quote1").textContent = quote1;
  document.querySelector("#author1").textContent = author1;
}
...
function generate2(){
  // grab all the keys in the dictionary (authors) and store in an array
  const authors2 = Object.keys(quotes);
  // grab a random key (author) and store it in author
  const author2 = authors2[Math.floor(Math.random() * authors2.length)];
  // grab the value(quote) that belongs to that key
  const quote2 = quotes[author]

  document.querySelector("#quote2").textContent = quote2;
  document.querySelector("#author2").textContent = author2;
}
